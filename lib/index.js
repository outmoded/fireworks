...
exports.compile = function () {
    ...
    var animation = [
        internals.launch(exports.color.blue, 15),
        internals.launch(exports.color.orange, 5),
        internals.launch(exports.color.aqua, 10)
    ];
...
console.log('var animation = ' + JSON.stringify(exports.compile()) + ';');
