...
internals.compile = function () {
    ...
    var animation = [
        [].concat(internals.launch(Colors.blue, 6), exports.combine(internals.burst(Colors.blue, 6), internals.tails(Colors.blue, 3), 'end')),
        [].concat(internals.launch(Colors.cyan, 3), exports.combine(internals.burst(Colors.cyan, 3), internals.tails(Colors.cyan, 3), 'end')),
        [].concat(internals.launch(Colors.aqua, 9), exports.combine(internals.burst(Colors.aqua, 9), internals.tails(Colors.aqua, 3), 'end'))
    ];
